...
<body>
<form:form action="/add-rom" method="post" modelAttribute="dulieuxem">
    <div class="row">
        <div class="col">
                                ...
                                <c:forEach items="${hsp}" var="chip" varStatus="i">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/remove-rom/${chip.id}" class="btn btn-outline-primary"
                                               tabindex="-1"
                                               role="button"
                                               onclick="if(!(confirm('Bạn có muốn thực hiện thao tác này không ? ')))return false;">Delete</a>
                                            <a href="/view-update-rom/${chip.id}" class="btn btn-outline-primary"
                                               tabindex="-1"
