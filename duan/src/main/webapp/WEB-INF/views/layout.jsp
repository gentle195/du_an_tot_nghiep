        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="production/index.jsp" class="site_title"><i class="fa fa-paw"></i> <span>Đạt đẹp trai ! <br></span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href=""><i class="fa fa-home"></i> Trang Chủ <span></span></a></li>
                  <li><a href=""><i class="fa fa-home"></i> Bán Hàng <span></span></a></li>
                  <li><a><i class="fa fa-edit"></i> Hoá Đơn <span></span></a>
                  <li><a><i class="fa fa-table"></i> Quản Lý Thông Tin <span class="fa fa-chevron-down"></span></a>
