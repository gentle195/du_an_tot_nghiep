...
<c:if test="${listSpgg.isEmpty()}">
    <div class="container">
        <h4>Không có sản phẩm !</h4>
    </div>
</c:if>
<c:if test="${not listSpgg.isEmpty()}">
    ...
    <ul class="pagination justify-content-center pagination-lg">
        <li class="page-item"><a class="page-link" href="/san-pham-giam-gia/hien-thi?pageNum=0">First</a></li>
        ...
        <li class="page-item"><a class="page-link" href="/san-pham-giam-gia/hien-thi?pageNum=${total-1}">Last</a></li>
    </ul>
</c:if>
<c:if test="${size==0}">
